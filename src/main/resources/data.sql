...
-- Poblar Balance
INSERT INTO "Balance" (event_id, source, amount) VALUES
    (1, 'Sponsorship Tech Solutions S.L.', 3000),
    (2, 'Sponsorship Innovate Asturias', 4000),
    (3, 'Rent a building for the event', -1000);
